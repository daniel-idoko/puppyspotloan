...
const FieldSet2: React.FC<Props> = ({ classes, paymentProtection, setPaymentProtection }) => {
    return (
        <>
{/* Payment Protection Cover */}
            <fieldset className={classes.fieldset}>
                ...
                <div style={{fontSize: '13px', marginBottom: '10px'}}>
                    <p className={classes.paragraph} style={{lineHeight: 1.3}}>Check coverage(s) desired. Puppy Spot will disclose the cost of this voluntary insurance to you. A separate enrollment form which discloses the terms and conditions must be signed for coverage to become effective.</p>
                </div>
