...
const FieldSet1: React.FC<Props> = ({ classes, accountNo1, applicationType1, desiredLoanType1, desiredLoanAmount1, desiredLoanTerm1, setAccountNo1, setApplication1, setDesiredLoadType1, setDesiredLoadAmount1, setDesiredLoadTerm1, accountNo1Bool, application1Bool, desiredLoadType1Bool, desiredLoadAmount1Bool, desiredLoadTerm1Bool }) => {
...
{/* Application Type */}
            <fieldset className={classes.fieldset}>
                ...
                <div style={{fontSize: '13px'}}>
                    ...
                    <p className={classes.paragraph} style={{margin: '0 0 10px'}}>You must be a member to apply over the internet. If you are not currently a member and would like to apply, please call us at (502) 382-0019</p>
                </div>
                ...
                <Grid container>
                    <Grid item className={classes.gridItemPadding} xs={12} md={4}>
                        ...
                        >
                            <option value=''>Select...</option>
                            <option value="Flexible Payments">Flexible Payments</option>
